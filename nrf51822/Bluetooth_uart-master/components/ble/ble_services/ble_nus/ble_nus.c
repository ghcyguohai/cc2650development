...
static uint32_t tx_char_add(ble_nus_t * p_nus, const ble_nus_init_t * p_nus_init)
{
    ...
    char_md.char_props.write         = 1;
    char_md.char_props.write_wo_resp = 1;
    //char_md.char_props.notify =p_nus->is_notification_enabled;
...
void ble_nus_on_ble_evt(ble_nus_t * p_nus, ble_evt_t * p_ble_evt)
{
    ...
    {
        case BLE_GAP_EVT_CONNECTED:   // this event indicate whether the communication is establishe successfully or not 
...
uint32_t ble_nus_init(ble_nus_t * p_nus, const ble_nus_init_t * p_nus_init)
{
   ...
   // p_nus->is_notification_enabled = false;
    ...
    p_nus->uuid_type=BLE_UUID_TYPE_UNKNOWN;
